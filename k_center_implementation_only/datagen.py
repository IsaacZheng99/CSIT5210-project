...
def run(args):
    ...
    filename = "synth_data_" + str(num) + "_" + str(cln) + "_" + str(dim) + "_" # synth_data_10400_5_2_1
    if vardensity:
...
if __name__ == '__main__':
    ...
    # python datagen.py arg1(seed=1) arg2(number_of_points=10389) arg3(dim=2) arg4(cln=5)  # synth_data_10400_5_2_1 = synth_data_'(num_nonoise+num_noise=10400)'_'(cln=5)'_'(dim=2)'_'(seed=1)'
    # python3 datagen.py 1 10389 2 5